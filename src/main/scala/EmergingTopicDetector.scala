...
object EmergingTopicDetector {
  ...
  def main(args: Array[String]) {
    ...
    englishTweets.saveAsTextFiles("/Users/chitti/spark/engtweets")
    ...
    joinrdd2.saveAsTextFiles("/Users/chitti/spark/joinrdd")
    ...
    topHashTag.saveAsTextFiles("/Users/chitti/spark/reduceop")

    val mapop= topHashTag.mapWithState(StateSpec.function(mappingFunc))
    ...
    mapop.saveAsTextFiles("/Users/chitti/spark/mapop")
    // Filtering the tweets based on popular Hashtag
    val popularTweets = mapop.join(joinrdd2)
    ...
    output.saveAsTextFiles("/Users/chitti/spark/output")
    ...
    output.foreachRDD { rdd =>
      ...
      }).coalesce(1).saveAsTextFile("/Users/chitti/spark1/twitterpopular2.txt")
    }
